                        ...
                        <?php foreach ($list as $id => $v): ?>
                            <tr>
                                ...
                                <td width="1%" class="text-center">
                                    <a href="<?= SiteRoot("_admin/dir_shift_templates/add_or_edit&id={$id}") ?>" class="btn btn-sm btn-primary rounded-pill" title="Изменить данные"><i class="bi bi-pencil-fill"></i></a>
                                </td>
                                <td width="1%" class="text-center">
