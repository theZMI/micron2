    ...
    var sh = {
        ...
        toolbar: {
            ...
            create: function (highlighter) {
                ...
                setTimeout(
                    () => {
                        const mainDiv = document.getElementById(highlighter.id);
                        // const langIndicator = document.createElement("div");
                        // div.style.className = "highlighter-lang-indicator";
                        // div.style.height = "100px";
                        // div.style.background = "red";
                        // div.style.color = "white";
                        // div.innerHTML = "LANG:" + highlighter?.params?.brush;
                        const langIndicator = '<div class="highlighter-lang-indicator">' + highlighter?.params?.brush + '</div>'
                        mainDiv.innerHTML = langIndicator + mainDiv.innerHTML;
                    },
                    0
                );
