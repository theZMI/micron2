...
(function (Plugins) {
    ...
    var AutosizeInput = (function () {
        function AutosizeInput(input, options) {
            ...
            // Init mirror
            var minWidth = typeof (this._options.minWidth) != "undefined" ? (this._options.minWidth - 26) : 34;
            var maxWidth = typeof (this._options.maxWidth) != "undefined" ? (this._options.maxWidth - 26) : 200;
            this._mirror = $('<span style="position:absolute; top:-999px; left:0; white-space:pre; min-width: ' + minWidth + 'px; max-width: ' + maxWidth + 'px"/>');
