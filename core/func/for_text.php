...
// Переводит аналогичные по написанию русские буквы в английские (например русская "А" в английскую "A", русская "В" в английскую "B" т.д.)
// Бывает нужна например для создания единого формата вписанного гос. номера автомобиля (для вставки в БД или поиска по ней)
function TranslateSimilarRuLettersToEn($text) {
    $translationTable = [
        'А' => 'A', 'В' => 'B', 'Е' => 'E', 'К' => 'K', 'М' => 'M',
        'Н' => 'H', 'О' => 'O', 'Р' => 'P', 'С' => 'C', 'Т' => 'T',
        'У' => 'Y', 'Х' => 'X',
    ...
    return strtr($text, $translationTable);
}
